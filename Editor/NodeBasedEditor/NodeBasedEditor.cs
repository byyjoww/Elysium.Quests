...
{
    public abstract class NodeBasedEditor<T> : EditorWindow where T : Node
    {
        ...
        protected virtual void OnClickAddNode(Vector2 mousePosition)
        {
            ...
            var node = CreateNode(mousePosition);
            nodes.Add(node);
        }

        protected abstract T CreateNode(Vector2 mousePosition);
